  ...
  describe('POST  200 for a succesful post to /assets', function () {
    test('should return a 200', function () {
      ...
      return (0, _assetMock.pCreateAssetMock)().then(function (mockResponse) {
        ...
        return _superagent2.default.post(apiURL + '/assets').set('Authorization', 'Bearer ' + token).field('description', 'descriptiontestvalue').attach('photo', __dirname + '/assets/asset_test.JPG').then(function (response) {
